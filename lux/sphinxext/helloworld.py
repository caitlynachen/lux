...
LUXWIDGET_JS_URL_DEFAULT = "https://raw.githubusercontent.com/lux-org/lux-widget/master/luxWidget/nbextension/static/extension.js"

class lux_df(nodes.General, nodes.Element):
	pass
...
class HelloWorld(Directive):
	...
	def run(self):
		...
		# js_path = os.path.join(fileDir, '../../lux-widget/luxWidget/nbextension/static/index.js')
		...
		# result = [target]
		js_path = "https://raw.githubusercontent.com/lux-org/lux-widget/master/luxWidget/nbextension/static/extension.js"
		target_id = "%s.%s" % (env.docname, basename(js_path))
...
def html_visit_altair_plot(self, node):
	...
	try:
		...
		with contextlib.redirect_stdout(f):
			df = pd.read_csv({'date': ['2020-01-01', '2020-02-01', '2020-03-01', '2020-04-01'], 'value': [10.5,15.2,20.3,25.2]})
			chart = LuxDataFrame._repr_html_(df)
	...
	if output == "none":
		...
		try:
			spec = chart.to_dict()
		except lux.utils.schemapi.SchemaValidationError:
...
def setup(app):
	...
	app.add_directive("helloworld", AltairPlotDirective)
